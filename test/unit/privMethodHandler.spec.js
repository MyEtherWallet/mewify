...
function angularApprovalHandlerStubFactory() {
  return sinon.stub({
    showTxConfirm: function() {}
  })
}

function serverStubFactory() {
  return sinon.stub({
...
describe('privMethodHandler.prototype.signAndSendTransaction', function() {
  // var pmh, fileIO, configs, angularApprovalHandler, server;
  //
  // before(function() {
  //   server = serverStubFactory();
  //
  //   fileIO = global.fileIO = fileIOStubFactory();
  //   configs = global.configs = configsStubFactory();
  //   angularApprovalHandler = global.angularApprovalHandler = angularApprovalHandlerStubFactory();
  //
  //   privMethodHandler.accounts.push({
  //     "address": "0x0cb19b15fe19414c93d59c599e94b2e497b620e9",
  //     "path": "/path/to/file"
  //   });
  //
  //   pmh = new privMethodHandler(server);
  // });
  //
  // after(function() {
  //   resetPrivMethodHandler();
  // })
  //
  // describe('when a transaction successful transaction occurs', function() {
  //
  // });
});
